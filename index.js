...
client.on('message', msg => {
  if (msg.content.toLowerCase() === '!tag') {
    msg.reply('Discord nickinin başına  koyarak  permi alabilirsin.');
  }
});
...
var oyun = [
    ...
    setInterval(function() {
        ...
        client.user.setGame(oyun[random], "https://www.twitch.tv/executionertiger");
        }, 2 * 2500);
